                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody v-if="posts.data">
                        <tr v-for="(post, index) in posts.data" :key="index">
                            <td>
                                <span class="custom-checkbox">
                                    <input type="checkbox" :id="'checkbox1' + index" name="options[]" value="1"
                                        @click.stop="postsSelect(post, $event)" />
                            ...
                            <td>
                                <img :src="'img/' + post.image"
                                    style="width: 100px; height: 60px; border: 1px solid #e7e7e7" alt="" />
                            </td>
                            <td>{{ post.user.name }}</td>
                            <td>
                                <a href="#editPostModal" class="edit" @click="editpost(post, $event)" data-toggle="modal"><i
                                        class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="#deletePostModal" class="delete" data-toggle="modal"><i class="material-icons"
                                        data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                <router-link :to="'/post/' + post.slug" class="" target="_blank"><i class="material-icons"
                                        data-toggle="tooltip" title="Delete">&#128065;</i></router-link>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="modal-content">
                    <form enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>body</label>
                                <textarea name="" v-model="body" cols="30" class="form-control" rows="10"></textarea>
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-body">
                            ...
                            <p class="text-warning">
                                <small>Selected Posts : <strong>{{ this.postSelected.length }}</strong></small>
                            </p>
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" />
...
export default {
    ...
    methods: {
        ...
        postsSelect(post, event) {
            let index = this.postSelected.indexOf(post.id);
            if (index > -1) {
